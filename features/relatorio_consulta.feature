Feature: Relatorio_consulta
  ...
  Scenario: cadastrar relatorio_consulta sem comentario
    Given eu estou na pagina de criar relatorio_consulta da consulta do paciente com cpf '35264079595'
  ...
  Scenario: cadastrar relatorio_consulta com comentario invalido
    Given eu estou na pagina de criar relatorio_consulta da consulta do paciente com cpf '89244280124'
  ...
  Scenario: cadastrar relatorio_consulta corretamente
    Given eu estou na pagina de criar relatorio_consulta da consulta do paciente com cpf '79414367870'
